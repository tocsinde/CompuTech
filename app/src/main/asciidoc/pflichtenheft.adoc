...
|Chef | Geschäftsführer | 1 
|Mitarbeiter| Angestellter, der für Service verantwortlich ist | 1 
|Privatkunde| Privatperson, die gleichzeitig Verbraucher ist| 2 
|Geschäftskunde | Kunde, der eine Firma vertritt| 2 
